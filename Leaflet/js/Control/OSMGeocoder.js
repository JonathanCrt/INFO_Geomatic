...
L.Control.OSMGeocoder = L.Control.extend({
    ...
    onAdd: function (map) {
        ...
        let form = this._form = L.DomUtil.create('form', className + '-form');
    ...
    _geocode : function (event) {
        ...
        let url = protocol + "//nominatim.openstreetmap.org/search" + L.Util.getParamString(params),
